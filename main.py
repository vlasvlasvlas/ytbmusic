...
from ui.dialogs import InputDialog, ConfirmDialog, ListDialog, ModalOverlay, TrackPickerDialog
...
# ListDialog, ModalOverlay, TrackPickerDialog are now imported from ui.dialogs

# Mixin for background-related functionality
from ui.handlers import BackgroundMixin


class YTBMusicUI(BackgroundMixin):
    def __init__(
        self,
    ...
    # Background methods (_set_player_background, _cancel_background_cycle,
    # _schedule_background_cycle, _apply_background_by_idx, _start_gradient_animation,
    # _stop_gradient_animation, _gradient_animate_loop, _apply_gradient_colors,
    # _cycle_background) are now inherited from BackgroundMixin
